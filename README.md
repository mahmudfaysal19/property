...
5. Finally, the most Interesting part is, there is a dedicated admin panel wheren you can manually add properties, select countries,cities and upload images.
...
5. Mantine Ui Library to create various components, Manrine Also Provides From validation Capabilities
